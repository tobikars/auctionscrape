...
var pjs = (function(){
    ...
    var runner = (function() {
        ...
        var SuiteManager = new function() {
            ...
            page.settings.userAgent = 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_2; en-us) AppleWebKit/531.21.8 (KHTML, like Gecko) Version/4.0.4 Safari/531.21.10';
            console.log('Set user agent to ' + page.settings.userAgent);
